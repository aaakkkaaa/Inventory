...
public class OVRGrabbable : MonoBehaviour
{
    ...
    protected Vector3 myOldParentPos;
...
//            Debug.Log("myPos.x=" + myPos.x);
    ...
    protected virtual void Start()
    {
        ...
        if (tag == "Green")
        {
            myOldParentPos = transform.parent.position;
        }
        // Mitya ---------
...
//            Debug.Log("Update " + this.gameObject.name);
        ...
        // Объект всегда на месте
        if (tag == "Hold")
        {
			//   Debug.Log("Position0=" + Position0);
...
//            transform.rotation = Rotation0;
        ...
        else if (tag == "Green")
        {
            ...
            ///            Debug.Log("transform.localPosition = " + transform.localPosition.ToString("F4"));


            //            Debug.Log("transform.parent.position = " + transform.parent.position.ToString("F4"));
            //            Debug.Log("transform.parent.parent.position = " + transform.parent.parent.position.ToString("F4"));

            FuncMove();
/*
            Vector3 myOffset1 = (this.transform.position - transform.parent.position);
            Vector3 myOffset2 = (this.transform.position - transform.parent.parent.position);
///            Debug.Log("myOffset1 = " + myOffset1.ToString("F4"));
///            Debug.Log("myOffset2 = " + myOffset2.ToString("F4"));

            Vector3 myOffset3 = transform.parent.position - myOldParentPos;
///            Debug.Log("myOffset3 = " + myOffset3.ToString("F4"));
            myOldParentPos = transform.parent.position;
            transform.localPosition = transform.localPosition + myOffset3;
            //            transform.position = transform.parent.parent.position - transform.localPosition;
            */
        }
